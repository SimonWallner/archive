...
Feature: update account credentials
  ...
  Scenario Outline: changing data
    ...
    Examples:
    | data | password | confirm | where | see |
    | all my data | correct  | confirm | on the home page | The data has been updated |
    | all my data | wrong    | don't confirm | on the user edit page | I should see an error |
    | a valid password | correct | don't confirm | on the home page  | The data has been updated |
    | a too short password | correct | don't confirm | on the user edit page  | I should see an error |
    | an invalid password | correct | don't confirm  | on the user edit page  | I should see an error |
    | all my data except my password | correct | confirm | on the home page  | The data has been updated |
